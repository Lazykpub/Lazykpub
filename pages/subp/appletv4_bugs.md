...
<div style="background-color: #E9EAFC; color: #000000; padding: 10px;">При отсутствии звука, или при любых других проблемах со звуком, установите настройки как на скриншоте ниже.</div>
...
<div style="background-color: #E9EAFC; color: #000000; padding: 10px;">🚨 При открытии приложения на экране отображается информация с различными ошибками.</div>

Ошибки могут быть разными - решение одно! Выполняйте рекомендации в конце списка ошибок.</div>
...
**Каждый следующий шаг делайте, если не помог предыдущий.  
‼️ Все шаги выполняйте именно в той последовательности, в которой они написаны.**
...
3. Пробуйте менять в роутере или на приставке DNS: от Google 8.8.8.8, от Cloudflare 1.1.1.1 или от Quad9 9.9.9.9. Или установите DNS на Авто.  
   <span style="color: green;">После каждой смены DNS - перезагружайте роутер и устройство. Если интернет подключен кабелем - надо переткнуть (вытащить и заново вставить) кабель в приставке.</span>
4. Пробуйте переустановить приложение с разными URL <a href="https://lazykpub.github.io/Lazykpub/pages/subp/appletv4_install">🔗по инструкции</a> . Предварительно обязательно удалите регистрацию устройства на сайте в **ЛК/Мои устройства**.
5. <span style="color: green;">Если пункты 1-4 ☝🏼 не помогли - используйте **только рекомендованные VPN**</span>.  
