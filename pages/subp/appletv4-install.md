...
‼️ 1. Перед переустановкой приложения удаляйте все лишние активации устройств на сайте в ЛК/Мои устройства - их не должно быть больше 1 рабочего.<br><br>
2. Не загружайте сразу несколько плейлистов, иначе даже рабочие могут не работать!<br><br>
3. Перед добавлением нового плейлиста обязательно выгружайте приложение из памяти: 2 раза нажать на кнопку «Home» (телевизор) и свайпом вверх по трекпаду. (Лучше переустановить приложение полностью).</div><br>
